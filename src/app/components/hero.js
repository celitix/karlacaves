...
export default function HeroSection() {
  const heading = "Karla Caves".split("");
  ...
  return (
    <section className="relative h-screen w-full flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-4">
        ...
        >
          Ancient Buddhist Sanctuaries Carved in Stone
        </motion.p>
        ...
        <motion.h1
          ...
          initial="hidden"
          animate="visible"
          className="text-cyan-500 text-5xl md:text-[120px] lg:text-[160px] font-semibold tracking-wider flex justify-center"
        >
